...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Roblox OS — a full desktop operating system with Roblox preinstalled.",
      },
    ],
    links: [
  ...
  component: () => (
    <html lang="en" className="antialiased h-full" suppressHydrationWarning>
      ...
      <body className="h-full overflow-hidden bg-os-bg text-os-fg">
        <PreviewHostBridge />
        <AuthProvider>
          <Outlet />
        </AuthProvider>
